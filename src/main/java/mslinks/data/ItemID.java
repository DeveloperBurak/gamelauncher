...
public class ItemID implements Serializable {
    ...
    public ItemID(ByteReader br, int maxSize) throws IOException, ShellLinkException {
        ...
        if (type == TYPE_DRIVE || type == TYPE_DRIVE_OLD) {
            ...
            switch (extensionVersion) {
                case EXT_VERSION_WINXP:
                    br.seek(4);
                    break;
                case EXT_VERSION_VISTA:
                    br.seek(22);
                    break;
                case EXT_VERSION_WIN7:
                    br.seek(26);
                    break;
                case EXT_VERSION_WIN8:
                    br.seek(30);
                    break;
                default:
    ...
    private static boolean isLongFilename(String filename) {
        ...
        // no matter whether it is FileHelper or directory
    ...
    private static String generateShortName(String longname) {
        ...
        // but actual index is generated by os while creating a FileHelper and stored in filesystem
